...
class Player(BasePlayer):
    ...
    group_1 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_2 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_3 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_4 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_5 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_6 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_7 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_8 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_9 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_10 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_11 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_12 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_13 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_14 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_15 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_16 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_17 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_18 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_19 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_20 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
    group_21 = models.IntegerField(blank=True, max=21, min=-2, label="(1 - 21)")
