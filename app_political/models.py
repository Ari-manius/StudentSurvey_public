...
class Player(BasePlayer):
    ...
    scalo_pep7 = models.StringField(blank=True, initial=0) #Julia Klöckner 
    ...
    social_networks_1 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_2 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_3 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_4 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_5 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_6 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_7 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_8 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_9 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_10 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_11 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
    social_networks_12 = models.IntegerField(blank=True, max=2, min=0, label="", initial=0)
